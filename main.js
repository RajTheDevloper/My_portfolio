...
let projects = [
  {
    image: 'textures/Land_registry.png',
    url: 'https://rajthedevloper.github.io/Land-Registry/',
  },
  {
    image: 'textures/Dhasoha.png',
    url: 'https://rajthedevloper.github.io/Dhasoha/home.html',
  },
  {
    image: 'textures/Advise_app.png',
    url: 'https://rajthedevloper.github.io/Advice-app/',
  },
  {
    image: 'textures/Anime.png',
    url: 'https://rajthedevloper.github.io/Ani-front_end/',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
gltfLoader.load(
  ...
  function (room) {
    ...
    video.src = 'textures/one_piece1.mp4';
    video.muted = true;
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('_Raju_', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
